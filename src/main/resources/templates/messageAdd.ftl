...
<@c.page>
    ...
    <h3 class="mb-3">Объявление о продаже недвижимости</h3>
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <label class="col-xl-2 col-lg-3 col-md-4 col-sm-12 col-12
                      col-form-label
                      pb-xl-2 pb-lg-2 pb-md-2 pb-sm-0 pb-0
                      text-xl-right text-lg-right text-md-right text-sm-left text-left">Фото объекта
                </label>
                <div class="col-xl-6 col-lg-7 col-md-8 col-sm-12 col-12">
            ...
            <div class="row mb-5">
                ...
                <button id="submit-message" type="submit" class="btn btn-info ">Опубликовать</button>
            </div>
